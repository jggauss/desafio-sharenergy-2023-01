            ...
            <form onSubmit={salvar} >
                <div className='form-cliente-inclui'>
                    <div className='campo-form-cliente-inclui'>
                        <div className='cor-campo-inclui-label'>
                            <label className='titulo-inclui-label'>Nome</label>
                        </div>
                        <div>
                            <input
                                value={nome}
                    ...
                    <div className='campo-form-cliente-inclui'>
                        <div className='cor-campo-inclui-label'>
                            <label className='titulo-inclui-label'>E-mail</label>
                        </div>
                        <div>
                            <input
                                value={email}
                    ...
                    <div className='campo-form-cliente-inclui'>
                        <div className='cor-campo-inclui-label'>
                            <label className='titulo-inclui-label'>Telefone</label>
                        </div>
                        <div>
                            <MaskedInput
                    ...
                    <div className='campo-form-cliente-inclui'>
                        <div className='cor-campo-inclui-label'>
                            <label className='titulo-inclui-label'>CPF</label>
                        </div>
                        <div>
                            <MaskedInput
                    ...
                    <div className='endereco'>
                        <div className='ruanumero'>
                            <label className='titulo-cliente-inclui'>Rua</label>
                            <input
                                value={rua}
                                className='titulo-cliente-inclui-input'
                                type="text"
                        ...
                        <div className='ruanumero'>
                            <label className='titulo-cliente-inclui'>Número</label>
                        ...
                        <div>
                            <label className='titulo-cliente-inclui'>Bairro</label>
                            <input
                                value={bairro}
                                className='titulo-cliente-inclui-input'
                                type="text"
                        ...
                        <div className='cidade-inclui' >

                            <label className='titulo-cliente-inclui'>Cidade</label>
                            <input
                                value={cidade}
                                className='titulo-cliente-inclui-input'
                                type="text"
                            ...
                            <div className='titulo-cliente-inclui'>
                                <label className='titulo-cep-inclui'>CEP</label>
                            </div>
                            ...
                            <div className='titulo-cliente-inclui'>
                                <label>Estado</label>{ }
                                <div className='titulo-cliente-inclui-input'>
